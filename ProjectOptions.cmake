...
macro(cpp_practice_setup_options)
  option(cpp_practice_ENABLE_HARDENING "Enable hardening" ON)
  option(cpp_practice_ENABLE_COVERAGE "Enable coverage reporting" OFF)
  cmake_dependent_option(
    cpp_practice_ENABLE_GLOBAL_HARDENING
    "Attempt to push hardening options to built dependencies"
    ON
    cpp_practice_ENABLE_HARDENING
    OFF)

  cpp_practice_supports_sanitizers()

  if(NOT PROJECT_IS_TOP_LEVEL OR cpp_practice_PACKAGING_MAINTAINER_MODE)
    option(cpp_practice_ENABLE_IPO "Enable IPO/LTO" OFF)
    option(cpp_practice_WARNINGS_AS_ERRORS "Treat Warnings As Errors" OFF)
    ...
    option(cpp_practice_ENABLE_IPO "Enable IPO/LTO" ON)
    option(cpp_practice_WARNINGS_AS_ERRORS "Treat Warnings As Errors" ON)
    option(cpp_practice_ENABLE_USER_LINKER "Enable user-selected linker" OFF)
    option(cpp_practice_ENABLE_SANITIZER_ADDRESS "Enable address sanitizer" ${SUPPORTS_ASAN})
    option(cpp_practice_ENABLE_SANITIZER_LEAK "Enable leak sanitizer" OFF)
    option(cpp_practice_ENABLE_SANITIZER_UNDEFINED "Enable undefined sanitizer" ${SUPPORTS_UBSAN})
    option(cpp_practice_ENABLE_SANITIZER_THREAD "Enable thread sanitizer" OFF)
    option(cpp_practice_ENABLE_SANITIZER_MEMORY "Enable memory sanitizer" OFF)
    option(cpp_practice_ENABLE_UNITY_BUILD "Enable unity builds" OFF)
  ...
  if(NOT PROJECT_IS_TOP_LEVEL)
    mark_as_advanced(
      ...
      cpp_practice_WARNINGS_AS_ERRORS
  ...
  if(LIBFUZZER_SUPPORTED AND (cpp_practice_ENABLE_SANITIZER_ADDRESS OR cpp_practice_ENABLE_SANITIZER_THREAD OR cpp_practice_ENABLE_SANITIZER_UNDEFINED))
...
macro(cpp_practice_global_options)
  ...
  if(cpp_practice_ENABLE_HARDENING AND cpp_practice_ENABLE_GLOBAL_HARDENING)
    ...
    message("${cpp_practice_ENABLE_HARDENING} ${ENABLE_UBSAN_MINIMAL_RUNTIME} ${cpp_practice_ENABLE_SANITIZER_UNDEFINED}")
    cpp_practice_enable_hardening(cpp_practice_options ON ${ENABLE_UBSAN_MINIMAL_RUNTIME})
  endif()
endmacro()
...
macro(cpp_practice_local_options)
  ...
  cpp_practice_set_project_warnings(
    cpp_practice_warnings
    ${cpp_practice_WARNINGS_AS_ERRORS}
    ""
    ""
    ""
  ...
  if(cpp_practice_ENABLE_USER_LINKER)
    ...
    cpp_practice_configure_linker(cpp_practice_options)
  endif()
  ...
  if(cpp_practice_ENABLE_CLANG_TIDY)
    cpp_practice_enable_clang_tidy(cpp_practice_options ${cpp_practice_WARNINGS_AS_ERRORS})
  endif()

  if(cpp_practice_ENABLE_CPPCHECK)
    cpp_practice_enable_cppcheck(${cpp_practice_WARNINGS_AS_ERRORS} "" # override cppcheck options
    )
  endif()
  ...
  if(cpp_practice_WARNINGS_AS_ERRORS)
  ...
  if(cpp_practice_ENABLE_HARDENING AND NOT cpp_practice_ENABLE_GLOBAL_HARDENING)
    include(cmake/Hardening.cmake)
    if(NOT SUPPORTS_UBSAN 
       OR cpp_practice_ENABLE_SANITIZER_UNDEFINED
       OR cpp_practice_ENABLE_SANITIZER_ADDRESS
    ...
    cpp_practice_enable_hardening(cpp_practice_options OFF ${ENABLE_UBSAN_MINIMAL_RUNTIME})
  endif()
