...
// configuration step. It creates a namespace called `cpp_practice`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cpp_practice::cmake::project_name, cpp_practice::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cpp_practice::cmake::project_version);
      return EXIT_SUCCESS;
    }
